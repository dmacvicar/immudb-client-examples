...
if args.batched:
    NotarizeTransactionBatch(
        ic, transaction_id, args.sender, args.recipient, args.amount, args.description)
else:
    NotarizeTransaction(ic, transaction_id, args.sender,
                        args.recipient, args.amount, args.description)
